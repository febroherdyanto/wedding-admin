                        ...
                        <div class="card">
                           <div class="card-header">
                            ...
                            <div class="card-block">
                                ...
                                <form class="form-material" action="<?= base_url('tamu/update/'.$t['idGuest']) ?>" method="POST">                                    
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            if($kategori): foreach ($kategori as $k): ?>
                                                <div class="input-group form-check">
                                                    <input class="form-check-input" type="radio" name="idKategori" value="<?= $k['idKategori']; ?>" id="<?= $k['idKategori']; ?>" <?php if($k['idKategori'] == $t['idKategori']){ echo "checked"; }else{ echo ""; } ?>>
                                    ...
                                    <div class="form-group form-primary">
                                        <input type="text" name="sapaanGuest" class="form-control" value="<?= $t['sapaanGuest']; ?>">
                                    ...
                                    <div class="form-group form-primary">
                                        <input type="text" name="namaGuest" class="form-control" required="" id="namaGuest" value="<?= $t['namaGuest']; ?>">
                                        <span class="form-bar"></span>
                                        <label class="float-label">Nama Tamu</label>
                                    </div>

                                    <div class="form-group form-info form-static-label">
                                        <input type="text" name="nicknameGuest" class="form-control" id="nicknameGuest" required="" value="<?= $t['nicknameGuest']; ?>" readonly>
                                        <span class="form-bar"></span>
                                    ...
                                    <div class="form-group form-primary">
                                        <input type="text" name="alamatGuest" class="form-control" value="<?= $t['alamatGuest']; ?>" required="">
                                        <span class="form-bar"></span>
                                        <label class="float-label">Alamat Singkat Tamu</label>
                                    </div>

                                    <div class="form-group form-primary">
                                        <input type="number" name="telpGuest" class="form-control" required="" value="<?= $t['telpGuest']; ?>">
                                        <span class="form-bar"></span>
