                        ...
                        <div class="card">
                           <div class="card-header">
                            ...
                            <div class="card-block">
                                ...
                                <form class="form-material" action="<?= base_url('kategori/update/'.$k['idKategori']) ?>" method="POST">
                                    <div class="form-group form-primary">
                                        <input type="text" name="namaKategori" value="<?= $k['namaKategori']; ?>" class="form-control" required="">
